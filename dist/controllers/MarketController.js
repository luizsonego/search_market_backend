...
export default {
    async create(request, response) {
        const { name, latitude, longitude, about, sunday, sunStart, sunEnd, monday, monStart, monEnd, tuesday, tueStart, tueEnd, wednesday, wedStart, wedEnd, thursday, thuStart, thuEnd, friday, friStart, friEnd, saturday, satStart, satEnd } = request.body;
